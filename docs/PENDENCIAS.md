...
**Atualizado em:** 20/08/2026, 08h40

---

## ✅ Decidido pelo dono em 19/08/2026, 23h06

| O quê | Decisão | O que isso trava |
|---|---|---|
| **Como os e-mails chegam** (era o item 24) | **Encaminhamento + webhook**, seguindo a recomendação | ✅ **Nenhuma senha de caixa de e-mail é guardada por nós** — essa é a razão inteira da escolha: credencial de caixa dá acesso amplo e permanente, e guardar uma é assumir um risco que não precisa existir. O e-mail é encaminhado para um endereço nosso, e um serviço entrega o conteúdo numa rota nossa. ⚠️ **O que depende de você**: um domínio e um serviço de entrada de e-mail — ver item 25 |
...
|---|---|---|
| **27** | 🔴 **Rede de ligações de um perfil + exportação para planilha — desenho medido, esperando aprovação** (20/08/2026, 08h40) | **Decidido pelo dono:** começa por **empresa (CNPJ)**, com a estrutura preparada para pessoa entrar depois; e **carrega a base completa da Receita**. **O que eu medi antes de desenhar** (julho/2026): Empresas **1,3 GB**, Estabelecimentos **5,0 GB**, Sócios **0,65 GB**, Simples **0,29 GB** — **~7,3 GB compactados**. O Supabase do CSI está no plano **pro**, banco hoje com **11 MB**. ⚠️ **O host da Receita (`dadosabertos.rfb.gov.br`, 200.152.38.155:443) não aceita conexão daqui** — testado, tempo esgotado, enquanto `gov.br` e o espelho respondem em menos de 1s. Isso muda o caminho do download e **cria uma questão de procedência**: baixar de espelho significa que a fonte da evidência é o espelho, não a Receita. **Falta a sua aprovação do desenho** (ver conversa de 20/08 08h40) |
