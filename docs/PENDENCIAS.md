...
| **25** | 🔴 **Falta um domínio e um serviço de entrada de e-mail** (19/08/2026, 23h06) | O **nosso lado** está pronto: rota de entrada, autenticação por fonte e gravação como evidência. O que falta é externo: (a) um **domínio** — hoje o CSI está em `csi-brasil.vercel.app`, e endereço de e-mail precisa de domínio próprio; (b) um **serviço de entrada** que receba o e-mail e chame nossa rota. Gratuitos: **Cloudflare Email Routing** (grátis, exige o domínio na Cloudflare) e a camada gratuita do Postmark ou Resend. ⚠️ **Escolher o serviço não muda o nosso código** — foi para isso que a rota nasceu agnóstica: ela aceita os nomes de campo mais comuns e guarda o corpo cru antes de interpretar qualquer coisa |
